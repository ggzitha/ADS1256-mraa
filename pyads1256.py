import time
import wiringpi as wp  # used for delay microseconds
import mraa as m
...
class ADS1256():
	...
	def SendByte(self, mybyte):
		...
		# mydata = chr(mybyte)
		result = self.x.writeByte(mybyte)   # notice workaround for single byte transfers JKR
	...
	def ReadByte(self):
		...
		"""
		MISObyte = self.x.writeByte(0xFF)
		return MISObyte #JKR
